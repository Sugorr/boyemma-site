...
export default function StriveExcel () {
    return (
        <section className="flex flex-col justify-center items-center w-full py-6 px-12 mt-32 gap-24">
            <p className="text-5xl font-bold">We <span className="text-default-accent">Strive</span> and <span className="text-default-base">Excel</span> For You</p>

            <section className="flex justify-center items-start gap-32 leading-relaxed">
                {/* Part One */}
                <div className="h-full w-full flex flex-col justify-center items-start gap-4">
                    ...
                    <div className="py-4">
                        <p className="text-2xl font-bold py-2">Nationwide Service</p>
                        <p>Have a product that needs to be delivered far? No problem, we’ll be able to deliver them anywhere you need it to be.</p>
                    </div>
                    <div className="mt-auto px-6 py-2 rounded-full border-2 border-default-accent cursor-pointer hover:bg-default-accent hover:text-white transition-colors duration-200 text-default-accent">
                        Learn More
                    </div>
                </div>
                {/* Part Two */}
                <div className="h-full w-full flex flex-col justify-center items-start gap-4">
                    ...
                    <div className="py-4">
                        <p className="text-2xl font-bold py-2">A Fleet you can count on</p>
                        <p>We always make sure that you’re goods are safe with us. Our Vehicles are well maintained and our fleet are always ready for your needs! 24/7 guaranteed.</p>
                    </div>
                    <div className="mt-auto px-6 py-2 rounded-full border-2 border-default-accent cursor-pointer hover:bg-default-accent hover:text-white transition-colors duration-200 text-default-accent">
                        Learn More
                    </div>
                ...
                <div className="h-full w-full flex flex-col justify-center items-start gap-4">
                    ...
                    <div className="py-4">
                        <p className="text-2xl font-bold py-2">On-Time</p>
                        <p>Need you goods to be deliver on time? Need no more, our fleet are ready to handle even the most time restricted deliveries.</p>
                    </div>
                    <div className="mt-auto px-6 py-2 rounded-full border-2 border-default-accent cursor-pointer hover:bg-default-accent hover:text-white transition-colors duration-200 text-default-accent">
                        Learn More
                    </div>
